...
for i in range (0,200):
    ...
    data_input = pd.read_csv('allcombined_for_ml.csv')
    ...
    data_come = data_input[['temp_coldhot','feel_air','feel_health','rh_o','winds_o','temp_o','Average']].copy()
    ...
    plt.legend(fontsize=30)
    plt.title('Comparision between Real and Predicted value',fontsize=30)
    plt.xlabel('Count (90-100)',fontsize=30)
    plt.ylim(90, 100)
    plt.xticks(fontsize=30)
    plt.yticks(fontsize=30)
    plt.grid()
